...
<body>
    <h1 align="center"><i>શ્રી શુભ આરંભ</i></h1>
    ...
    <div id="invoice" style="display: none;">
        <h1 align="center"><i>શ્રી શુભ આરંભ</i></h1>
	<p>Aja J. Patel<br>Mo.98986 40066<br>Ph.-02691 299028</p>
	<h2>Invoice</h2>
        ...
        <p>
              <ul>
                      <li>ફેન્સી સાડી, ચણિયા ચોલી, ડ્રેસ, ડીઝાઈનર સાડી</li> 
                      <li>પહેરામણીની સાડી થી પાનેતર સુધીની બધીજ સાડી મળશે</li> 
                      <li>ચણિયા ચોલી  બ્રાઈડલ સાઈડર બધીજ મળશે</li>
              </ul>
       </p>
        <p align="center"> 58,59,60,મિડલ વીગ, નંદની પ્લાઝા, મોડાસા રોડ, કપડવંજ-387620</p>
	<p align="right">શ્રી શુભ આરંભ<br><font size="1">Authorised Signatory</font></p>
       <p>
              <ul>
			<li><font size="1">સિલ્ક તથા હેન્ડવર્કમાં ડ્રાયકલીન કરાવવું ફરજીયાત છે. </font></li>
			<li><font size="1">ઉત્પાદકો તરફથી કાપડ, કલર, જરીની કોઈ ગેરંટી આપવામાં આવતી નથી. </font></li>
                        <li><font size="1">વેચેલ માલ પરત લેવામાં આવશે નહીં. </font></li>
                        <li><font size="1">ન્યાયક્ષેત્ર કપડવંજ ને આધીન. </font></li> 
	      </ul>
	</p>          
    </div>
